...
public class TerrainEBColdCypressForest extends TerrainBase
{
	...
	public TerrainEBColdCypressForest(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 74f);
	}
	
	public TerrainEBColdCypressForest(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
