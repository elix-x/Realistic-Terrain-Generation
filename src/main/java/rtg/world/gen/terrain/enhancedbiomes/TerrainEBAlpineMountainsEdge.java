...
public class TerrainEBAlpineMountainsEdge extends TerrainBase
{
	...
	public TerrainEBAlpineMountainsEdge(float mountainWidth, float mountainStrength, float depthLake)
	{
		this(mountainWidth, mountainStrength, depthLake, 260f, 70f);
	}
	
	public TerrainEBAlpineMountainsEdge(float mountainWidth, float mountainStrength, float depthLake, float widthLake, float height)
	{
		width = mountainWidth;
